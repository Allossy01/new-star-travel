...
export const testimonials: Testimonial[] = [
  ...
  {
    id: '2',
    nameEn: 'Fatima Zahra Idrissi',
    nameAr: 'فاطمة الزهراء الإدريسي',
    nameFr: 'Fatima Zahra Idrissi',
  ...
  {
    id: '3',
    nameEn: 'Omar Bensouda',
    nameAr: 'عمر بنسودة',
    nameFr: 'Omar Bensouda',
  ...
  },
  {
    ...
    reviewAr: 'باقة الحج VIP كانت تستحق كل درهم. فنادق خمس نجوم في مكة المكرمة والمدينة المنورة، وجبات مقدمة، ومرشد رائع شرح كل شيء بشكل جميل.',
